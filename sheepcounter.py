...
model=YOLO("Models/yolov8l.pt").to(device)
...
while cap.isOpened():
    ...
    if ret:
        ...
        frame = og_frame.copy()
        results = model(frame, classes=18, conf=0.6)
        ...
        cv2.putText(og_frame, f"Sheep Count: {person_count}", (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2, cv2.LINE_AA)
